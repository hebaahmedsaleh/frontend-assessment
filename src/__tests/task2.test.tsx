import {render, screen, waitFor, waitForElementToBeRemoved, queryByTestId, fireEvent     } from '@testing-library/react';
...
test('check if clicked on page 2 in  pagination',  async () => {
    ...
    setTimeout(() => {
        expect((pagination.getByText('2').parentElement?.className)).toBe('rc-pagination-item rc-pagination-item-2 rc-pagination-item-active')
    }, 9000);
